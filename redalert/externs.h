...
extern char const* const HardCodedBStateNames[BSTATE_COUNT];
extern char const* const HardcodedDoControlsName[DO_COUNT];
...
extern const char* FacingNames[FACING_COUNT];
